...
if (isset($_POST['inscription'])) {
  ...
  //check entreprise
  $check = "SELECT * FROM utilisateur WHERE matricule = $matricule";
  $result = mysqli_query($conn, $check);
  $nombre = mysqli_num_rows($result);

  if ($nombre == 0) {
    //insertion
    $sql = "INSERT INTO utilisateur ( matricule, nom, prenom,	entreprise,	motdepasse_utilisateur, date_enregistrement) 
    VALUES ('$matricule','$nom','$prenom', '$entreprise', '$motdepasse', '$date_inscription')";

    if (mysqli_query($conn, $sql)) {
      echo "Utilisateur enregistré avec succes";
    } else {
      echo "Error: " . $sql . "<br>" . mysqli_error($conn);
    }
  } else {
    echo "L'utilisateur est déja enregistrer";
  }
}
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Créer un nouveau compte</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form method="post"  enctype="multipart/form-data" role="form text-left">
                  <div class="mb-3">
                    <label class="mr-sm-2" for="inlineFormCustomSelect">Matricule</label>
                    <input type="text" class="form-control" name="matricule" id="matricule" placeholder="Matricule" aria-label="matricule" aria-describedby="matricule-addon">
                  </div>
                  <div class="mb-3">
                    <label class="mr-sm-2" for="inlineFormCustomSelect">Nom</label>
                    <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom" aria-label="nom" aria-describedby="nom-addon">
                  </div>
                  <div class="mb-3">
                    <label class="mr-sm-2" for="inlineFormCustomSelect">Prenom</label>
                    <input type="text" class="form-control" name="prenom" id="prenom" placeholder="Prenom" aria-label="prenom" aria-describedby="prenom-addon">
                  </div>
                  <div class="mb-3">
                  <label class="mr-sm-2" for="inlineFormCustomSelect">Entreprise</label>
                    <select class="form-control" id="inlineFormCustomSelect" name="entreprise" aria-label="entreprise" aria-describedby="entreprise-addon">
                        <option selected>choisir votre entreprise</option>
                  ...
                  <!-- <div class="mb-3">
                  <label class="mr-sm-2" for="inlineFormCustomSelect">Entreprise</label>
                    <select class="form-control" id="inlineFormCustomSelect"  name="departement">
                        <option selected>choisir votre departement</option>
                  ...
                  <div class="mb-3">
                    <label class="mr-sm-2" for="inlineFormCustomSelect">Mot de passe</label>
                  ...
                  <div class="text-center">
                    <button type="submit" name="inscription" class="btn bg-gradient-info w-100 my-4 mb-2">Inscription</button>
                  </div>
                  <p class="text-sm mt-3 mb-0">Vous avez deja un compte? <a href="seconnecter.php" class="text-info text-gradient font-weight-bold">Connectez-Vous.</a></p>
                </form>
              </div>
            </div>
          </div>
