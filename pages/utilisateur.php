        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header col-6 pb-0">
              <h6>Informations Utilisateurs</h6>
              ...
              <div class="table-responsive p-0">
                ...
                <?php
                 ...
                 <?php
                  ...
                  <thead>
                  <tr>
                        <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-73">matricule</td>
                        <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-73">nom</td>
                        <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-73">prenom</td>
                        <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-73">entreprise</td>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td class="text-xs font-weight-bold mb-0"><?php echo $row["matricule"]; ?></td>
                        <td class="text-xs text-secondary mb-0"><?php echo $row["nom"]; ?></td>
                        <td class="text-xs text-secondary mb-0"><?php echo $row["prenom"]; ?></td>
                        <td class="text-xs text-secondary mb-0"><?php echo $row["entreprise"]; ?></td>
                        <td>
