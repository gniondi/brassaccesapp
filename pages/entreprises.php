...
if (isset($_POST['Ajouter'])) {
  ...
  //check entreprise
  $check = "SELECT * FROM entreprise where libelle_entreprise ='$entreprise'";
  $result = mysqli_query($conn, $check);
  $nombre = mysqli_num_rows($result);

  if ($nombre == 0) {
    //insertion
    $sql = "INSERT INTO entreprise (libelle_entreprise) VALUES ('$entreprise')";

    if (mysqli_query($conn, $sql)) {
      echo "Entreprise enregistré avec succes";
    } else {
      echo "Error: " . $sql . "<br>" . mysqli_error($conn);
    }
  } else {
    echo "L'entreprise est déja enregistré";
  }
}
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/badges.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Entreprises</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Entreprises</h6>
        </nav>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Ajouter Entreprise</h5>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="entreprise" placeholder="Ajouter une entreprise" aria-label="entreprise" aria-describedby="entreprisee-addon">
                </div>
              </div>
            </div>
        ...
        <div class="col-md-8 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Informations Entreprises</h6>
            </div>
              ...
              <div class="table-responsive p-0">
                ...
                <?php
                 ...
                 <?php
                  ...
                  <thead>
                  <tr>
                        <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-73">Company Name</td>
                        <!-- <td class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-73">Email Address:</td>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td class="text-xs font-weight-bold mb-0"><?php echo $row["libelle_entreprise"]; ?></td>
                        <td>
